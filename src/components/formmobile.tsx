...
import { DatePickerWithRangeMobile } from "./datapickermobile";
...
const InputField: React.FC<FormFieldProps> = ({
  ...
  return (
    <div className={`h-[55px] min-w-[200px] max-w-[200px] ${className}`}>
      ...
      {showResults && (
        <div className="Lista !z-30 !gap-0">
          {results &&
            results.data &&
...
const MainFormMobile: React.FC<FormProps> = () => {
  ...
  return (
    <div className=" w-full mx-3">
      ...
      >
        ...
        <div className="flex">
          <div className="flex-1 mr-4 center-col w-full space-y-2">
            <InputField
              placeholder="Origem"
              className="ml-5 !w-full !max-w-full"
            ...
            <InputField
              ...
              className="ml-5 !w-full !max-w-full"
            />
            <DatePickerWithRangeMobile onChange={handleDate} />
            <button
              type="submit"
              className="bg-main_secondary button-form center ml-[16px] !min-w-full"
            >
              Procurar
            </button>
          </div>
